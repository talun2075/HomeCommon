...
namespace PlaylistWPF
{
    internal static class Functions
    {
        ...
        private static readonly List<GenreItem> allViewedGenres = new();
        private static readonly List<GenreItem> allViewedHiddenGenres = new();
        ...
        /// <summary>
        /// Gibt an, ob in der Settings die Sortorder angepasst wurde
        /// </summary>
        public static String PlaylistSortOrder { get { return playlistsortorder; } }

        public static Boolean PictureExtract { get; set; } = false;

        public static String MusicIndexPath { get; set; } = String.Empty;
        public static string PictureExtractPath { get; set; } = String.Empty;
        /// <summary>
        ...
        internal static Boolean ReadFiles()
        {
            ...
            {
               MessageBox.Show(@"Das Verzeichis aus der App.Config für x existiert nicht", @"Fehler", MessageBoxButton.OK, MessageBoxImage.Error);
                return false;
            }
            ...
            foreach (var setting in settings)
            {
                switch (setting.FirstAttribute.Value)
                {
                    ...
                    case "Autorun":
                        ...
                        break;
                    case "PictureExtract":
                        PictureExtract = Convert.ToBoolean(setting.Value);
                        break;
                    case "PictureExtractPath":
                        PictureExtractPath = setting.Value;
                        break;
                    case "MusicIndexPath":
                        MusicIndexPath = setting.Value;
                        break;
                }
