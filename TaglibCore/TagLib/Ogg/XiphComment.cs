...
namespace TagLib.Ogg
{
    ...
    public class XiphComment : Tag, IEnumerable<string>
    {
        ...
        /// </summary>
        private readonly Dictionary<string, string[]> field_list =
            new();
        ...
        protected void Parse(ByteVector data)
        {
            ...
            for (int i = 0; i < comment_fields; i++)
            {
                ...
                if (field_list.TryGetValue(key, out string[] values))
                {
                    Array.Resize(ref values,
                        values.Length + 1);
        ...
        public override uint TrackCount
        {
            get
            {
                ...
                if ((text = GetFirstField("TRACKTOTAL")) !=
                    null && uint.TryParse(text, out uint value))
                    return value;
        ...
        public override IPicture[] Pictures
        {
            get
            {
                ...
                {
                    ByteVector data = new(Convert.FromBase64String(covers[ii]));
        ...
        public bool IsCompilation
        {
            get
            {
                ...
                if ((text = GetFirstField("COMPILATION")) !=
                    null && int.TryParse(text, out int value))
                {
                    return value == 1;
                }
                return false;
