...
#region Private Fieds
		...
		/// </summary>
		private readonly Dictionary<string, string> keyword_store = new();
...
#region Public Properties
        ...
        public override DateTime? DateTime {
			get {
                ...
                if (System.DateTime.TryParse (date, out DateTime ret))
					return ret;
...
#region Public Methods
		...
		public string GetKeyword (string keyword)
		{
            ...
            keyword_store.TryGetValue(keyword, out string ret);
        ...
        /// </summary>
        /// <returns>
        ///    A <see cref="IEnumerator"/> to enumerate
        ///    the keywords.
        /// </returns>
