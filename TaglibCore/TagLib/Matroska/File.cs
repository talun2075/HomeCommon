    ...
    public class File : TagLib.File
    {
        ...
        private void Read (ReadStyle propertiesStyle)
        {
            ...
            while (offset < (ulong) Length) {
                EBMLElement element = new(this, offset);
        ...
        private void ReadHeader (EBMLElement element)
        {
            ...
            while (i < element.DataSize) {
                EBMLElement child = new(this, element.DataOffset + i);
        ...
        {
            ulong i = 0;
            string tag_name = null, tag_string = null;
                    ...
                    case MatroskaID.MatroskaTrackType: {
                            ...
                            switch (track_type) {
                                case TrackType.Video: {
                                        VideoTrack track = new(this, element);

                                        tracks.Add (track);
                                        break;
                                    }
                                case TrackType.Audio: {
                                        AudioTrack track = new(this, element);

                                        tracks.Add (track);
                                        break;
                                    }
                                case TrackType.Subtitle: {
                                        SubtitleTrack track = new(this, element);
