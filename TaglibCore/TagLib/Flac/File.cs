...
namespace TagLib.Flac {
    ...
    /// </summary>
    /// <remarks>
    ///    A <see cref="Ogg.XiphComment" /> will be added
	...
	public class File : NonContainer.File
	{
		...
		public override void Save ()
		{
			...
			try {
                ...
                IList<Block> old_blocks = ReadBlocks(ref metadata_start,
                    out long metadata_end, BlockMode.Blacklist,
		...
		protected override void ReadStart (long start,
		                                   ReadStyle propertiesStyle)
		{
            IList<Block> blocks = ReadBlocks(ref start, out long end,
        ...
        protected override Properties ReadProperties (long start,
		                                              ...
		                                              ReadStyle propertiesStyle)
		{
			StreamHeader header = new(header_block,
				end - stream_start);
	...
	public class Metadata : CombinedTag
	{
		...
		/// </summary>
		private readonly List<IPicture> pictures = new();
