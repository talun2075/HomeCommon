...
#region Private Methods
		...
		private void SaveMetadata ()
		{
			...
			ByteVector metadata_blocks = new();
		...
		private ByteVector RenderGifCommentBlock ()
		{
            ...
            if (GetTag(TagTypes.GifComment) is not GifCommentTag comment_tag)
                return null;
			...
			ByteVector comment_bytes = new(comment);
			byte block_max = 255;
