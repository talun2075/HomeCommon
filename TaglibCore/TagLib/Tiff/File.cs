...
{
    /// <summary>
    ///    This class extends <see cref="BaseTiffFile" /> to provide tagging
...
#region Private Methods
		...
		protected virtual Properties ExtractProperties ()
		{
            ...
            int width = (int)(structure.GetLongValue(0, (ushort)IFDEntryTag.ImageWidth) ?? 0);
            int height = (int)(structure.GetLongValue(0, (ushort)IFDEntryTag.ImageLength) ?? 0);
