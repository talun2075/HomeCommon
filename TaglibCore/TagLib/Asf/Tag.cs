...
namespace TagLib.Asf {
	...
	public class Tag : TagLib.Tag, IEnumerable<ContentDescriptor>
	{
		...
		/// </summary>
		private readonly MetadataLibraryObject metadata_library =
			new();
		...
		{
			ByteVector v = new((byte) picture.Type);
