...
namespace TagLib.Asf {
	...
	public class DescriptionRecord
	{
        ...
        /// </summary>
        /// <param name="file">
        ///    A <see cref="File" /> object to read the raw ASF
		...
		public uint ToDWord ()
		{
            if (type == DataType.Unicode && strValue != null &&
                uint.TryParse(strValue, out uint value))
                return value;
		...
		{
            if (type == DataType.Unicode && strValue != null &&
                ulong.TryParse(strValue, out ulong value))
                return value;
		...
		{
            if (type == DataType.Unicode && strValue != null &&
                ushort.TryParse(strValue, out ushort value))
                return value;
