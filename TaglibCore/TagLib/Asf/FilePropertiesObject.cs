...
namespace TagLib.Asf {
	...
	public class FilePropertiesObject : Object
	{
		...
		/// </summary>
		private readonly ulong file_size;
		...
		/// </summary>
		private readonly ulong data_packets_count;
		...
		/// </summary>
		private readonly ulong preroll;
		...
		/// </summary>
		private readonly uint minimum_data_packet_size;
		
		/// <summary>
		///    Contains the maxximum packet size.
		/// </summary>
		private readonly uint maximum_data_packet_size;
		
		/// <summary>
		///    Contains the maximum bitrate of the file.
		/// </summary>
		private readonly uint maximum_bitrate;
