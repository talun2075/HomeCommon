...
#region Private Fields
		...
		/// </summary>
		private readonly List<Frame> frame_list = new();
...
#region TagLib.Tag
		...
		public override IPicture [] Pictures {
			...
			set {
				...
				foreach(IPicture picture in value) {
                    if (picture is not AttachedPictureFrame frame)
        ...
        public override void CopyTo (TagLib.Tag target, bool overwrite)
		{
            ...
            List<Frame> frames = new(frame_list);
