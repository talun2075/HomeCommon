...
#region Public Properties
		...
		public IFDStructure ExifIFD {
			get {
				if (exif_ifd == null) {
                    if (Structure.GetEntry(0, IFDEntryTag.ExifIFD) is not SubIFDEntry entry)
                    {
		...
		public IFDStructure GPSIFD {
			get {
				if (gps_ifd == null) {
                    if (Structure.GetEntry(0, IFDEntryTag.GPSIFD) is not SubIFDEntry entry)
                    {
...
#region Metadata fields
		...
		public override string Comment {
			get {
                if (ExifIFD.GetEntry(0, (ushort)ExifEntryTag.UserComment) is not UserCommentIFDEntry comment_entry)
                {
        ...
        /// </summary>
        /// <value>
        ///    A <see cref="Nullable"/> with the time of capturing.
        /// </value>
        ...
        /// </summary>
        /// <value>
        ///    A <see cref="Nullable"/> with the time of digitization.
        /// </value>
        ...
        public override double? Latitude {
			get {
                ...
                if (gps_ifd.GetEntry (0, (ushort) GPSEntryTag.GPSLatitude) is not RationalArrayIFDEntry degree_entry || degree_ref == null)
					return null;
        ...
        public override double? Longitude {
			get {
                ...
                if (gps_ifd.GetEntry (0, (ushort) GPSEntryTag.GPSLongitude) is not RationalArrayIFDEntry degree_entry || degree_ref == null)
					return null;
...
#region Private Methods
		...
		/// </returns>
		private static Rational[] DegreeToRationals (double angle)
		{
			if (angle < 0.0 || angle > 180.0)
				throw new ArgumentException(null, nameof(angle));
