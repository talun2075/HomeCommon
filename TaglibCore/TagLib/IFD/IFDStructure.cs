...
#region Private Fields
		...
		/// </summary>
		internal readonly List<IFDDirectory> directories = new();
...
#region Public Methods
        ...
        /// <summary>
        ///    Returns a <see cref="Nullable"/> containing the
        ...
        /// </param>
        /// <returns>
        ///    A <see cref="Nullable"/> containing the
        ...
        /// <summary>
        ///    Returns a <see cref="Nullable"/> containing the
        ///    <see cref="DateTime"/> stored in the entry defined
        ...
        /// <returns>
        ///    A <see cref="Nullable"/> containing the
        ///    <see cref="DateTime"/> stored in the entry, or
        ///    <see langword="null" /> if no such entry is contained or it
        ...
        ///    represent the value by a <see cref="Rational"/>.
        /// </param>
        public void SetRationalValue (int directory, ushort entry_tag, double value)
		{
			...
			Rational rational = new((uint) (scale * value), scale);
