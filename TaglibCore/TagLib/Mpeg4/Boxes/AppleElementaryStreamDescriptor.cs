...
namespace TagLib.Mpeg4 {
	...
	public class AppleElementaryStreamDescriptor : FullBox
	{
		...
		/// </summary>
		private readonly ushort es_id;
		
		/// <summary>
		///    Contains the stream priority.
		/// </summary>
		private readonly byte stream_priority;
		
		/// <summary>
		///    Contains the object type ID.
		/// </summary>
		private readonly byte object_type_id;
		...
		/// </summary>
		private readonly uint buffer_size_db;
		...
		/// </summary>
		private readonly ByteVector decoder_config;
