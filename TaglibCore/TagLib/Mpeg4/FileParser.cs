...
namespace TagLib.Mpeg4 {
	...
	public class FileParser
	{
		...
		/// </summary>
		private readonly List<IsoUserDataBox> udta_boxes = new();
		...
		/// </summary>
		private readonly List<Box> stco_boxes = new();
		
		/// <summary>
		///    Contains the "stsd" boxes found in the file.
		/// </summary>
		private readonly List<Box> stsd_boxes = new();
