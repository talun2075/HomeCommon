    ...
    public class AppleTag : Tag, IEnumerable<Box>
	{
		...
		public void SetDashBox(string meanstring, string namestring, string datastring)
		{
			...
			if (data_box != null) {
				...
				AppleAdditionalInfoBox amean_box = new(BoxType.Mean);
				AppleAdditionalInfoBox aname_box = new(BoxType.Name);
				AppleDataBox adata_box = new(BoxType.Data, 1);
				amean_box.Text = meanstring;
				aname_box.Text = namestring;
				adata_box.Text = datastring;
				AppleAnnotationBox whole_box = new(BoxType.DASH);
