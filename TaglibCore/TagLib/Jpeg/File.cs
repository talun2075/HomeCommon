...
#region Private Methods
        ...
        /// </summary>
        /// <returns>
        ///    A <see cref="Marker"/> with the second byte of the segment marker.
        /// </returns>
		...
		private ByteVector RenderExifSegment ()
		{
			...
			ByteVector data = new(new byte [] { 0xFF, (byte) Marker.APP1 });
		...
		private ByteVector RenderCOMSegment ()
		{
            ...
            if (GetTag(TagTypes.JpegComment) is not JpegCommentTag com_tag)
                return null;
			...
			// create segment
			ByteVector data = new(new byte [] { 0xFF, (byte) Marker.COM });
			data.Add (ByteVector.FromUShort ((ushort) segment_size));
