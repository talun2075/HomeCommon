...
namespace TagLib.Aiff
{
	...
	public class File : TagLib.File
	{
			...
			: base(abstraction)
		{
			...
			try
			{
                Read(true, propertiesStyle, out uint aiff_size,
                     out long tag_start, out long tag_end);
            }
			finally
			{
		...
		public override void Save()
		{
			...
			try
			{
                ...
                Read(false, ReadStyle.None, out uint aiff_size,
                     out long tag_start, out long tag_end);
		                  ...
		                  out long tag_end)
		{
			    ...
			    style != ReadStyle.None)
			{
				...
				StreamHeader header = new(header_block, aiff_size);
