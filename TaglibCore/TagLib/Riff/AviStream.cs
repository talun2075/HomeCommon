...
namespace TagLib.Riff
{
	...
	public abstract class AviStream
	{
		...
		/// </summary>
		private readonly AviStreamHeader header;
	...
	public struct AviStreamHeader
	{
		...
		/// </summary>
		private readonly ByteVector type;
		
		/// <summary>
		///    Contains the stream handler.
		/// </summary>
		private readonly ByteVector handler;
		...
		/// </summary>
		private readonly uint initial_frames;
		...
		/// </summary>
		private readonly uint suggested_buffer_size;
		...
		/// </summary>
		private readonly uint sample_size;
