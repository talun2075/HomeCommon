...
namespace TagLib.Riff
{
	...
	public class AviHeaderList
	{
        ...
        /// </summary>
        readonly AviHeader header;

        /// <summary>
        ///    Contains the AVI codec information.
        /// </summary>
        readonly List<ICodec> codecs = new();
		                      ...
		                      int length)
		{
			...
			List list = new(file, position, length);
	...
	public struct AviHeader
	{
        ...
        /// </summary>
        readonly uint microseconds_per_frame;

        /// <summary>
        ///    Contains the maximum number of bytes per second.
        /// </summary>
        readonly uint max_bytes_per_second;
        ...
        /// </summary>
        readonly uint initial_frames;

        /// <summary>
        ///    Contains the number of streams.
        /// </summary>
        readonly uint streams;

        /// <summary>
        ///    Contains the suggested buffer size.
        /// </summary>
        readonly uint suggested_buffer_size;
