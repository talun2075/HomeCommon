...
namespace MP3File
{
    public class MP3File
    {
        ...
        public Int32 Tracknumber { get; set; } = -1;
        ...
        public String BewertungMine { get; set; } = "0";
        public String Genre { get; set; } = "leer";
        public TimeSpan Laufzeit { get; set; } = new TimeSpan();
        public Boolean HatCover { get; set; } = true;
        public String Verlag { get; set; } = String.Empty;
        public String Typ { get; set; } = String.Empty;
        public String Kommentar { get; set; } = String.Empty;
        /// <summary>
        /// Prüft auf bestimmte Werte ob ide MP3 leer ist.
        /// </summary>
        /// <returns></returns>
        public Boolean IsEmpty()
        {
            return (string.IsNullOrEmpty(Titel)&& string.IsNullOrEmpty(Artist) && string.IsNullOrEmpty(Album) && string.IsNullOrEmpty(Pfad));
        }
    }
    /// <summary>
    ...
    public static class MP3ReadWrite
    {
        ...
        /// </summary>
        public static List<MP3File> listOfCurrentErrors = new();
        /// <summary>
        ...
        public static Boolean WriteMetaData(MP3File song)
        {
            ...
            try
            {
                if (string.IsNullOrEmpty(song.Pfad)) return false;
                ...
                switch (taglibobjekt.MimeType)
                {
                    ...
                    case "taglib/mp3":
                        ...
                        if (id3v2tag != null)
                        {
                            ...
                            {
                                TagLib.Id3v2.CommentsFrame mms = new("Songs-DB_Custom2", "xxx")
                                {
                                    Text = "Aufwecken"
                                };
                            ...
                            {
                                TagLib.Id3v2.CommentsFrame mms = new("Songs-DB_Custom3", "xxx")
                                {
                                    Text = "true"
                                };
                                id3v2tag.AddFrame(mms);
                            ...
                            if (!setratingMine)
                            {
                                TagLib.Id3v2.CommentsFrame mms = new("Songs-DB_Custom1", "xxx")
                                {
                            ...
                            if (!setgelegenheit)
                            {
                                TagLib.Id3v2.CommentsFrame mms = new("MusicMatch_Situation", "xxx");
                                TagLib.Id3v2.CommentsFrame sdo = new("Songs-DB_Occasion", "xxx");
                            ...
                            {
                                TagLib.Id3v2.CommentsFrame mms = new("MusicMatch_Tempo", "xxx");
                                TagLib.Id3v2.CommentsFrame sdo = new("Songs-DB_Tempo", "xxx");
                            ...
                            if (!setstimmung)
                            {
                                TagLib.Id3v2.CommentsFrame mms = new("MusicMatch_Mood", "xxx");
                                TagLib.Id3v2.CommentsFrame sdo = new("Songs-DB_Mood", "xxx");
            ...
            try
            {
                ...
                if (File.Exists(lied.Pfad))
                {
                    ...
                    if (taglibobjekt.Tag.Lyrics != null)
                    {
                        ...
                        dummy = Regex.Replace(dummy, "Deutsch:", "<br /><b>Deutsch:</b><br />");
                        lied.Lyric = Regex.Replace(dummy, "Englisch:", "<br /><b>Englisch:</b><br />");
                    }
                    else
                    {
                    ...
                    lied.Kommentar = taglibobjekt.Tag.Comment?? String.Empty;
                    //Cover
                    ...
                    switch (taglibobjekt.MimeType)
                    {
                        ...
                        case "taglib/m4a":
                            ...
                            {
                                int.TryParse(taglibobjekt.Tag.Rating, out int r);
                            ...
                            {
                                Enum.TryParse(taglibobjekt.Tag.Mood, false, out Enums.Stimmung ls);
                                lied.Stimmung = ls;
                            }
                        ...
                        case "taglib/mp3":
                            ...
                            if (taglibobjekt.GetTag(TagLib.TagTypes.Id3v2) is TagLib.Id3v2.Tag id3v2tag)
                            {
        ...
        public static Boolean WritePlaylist(List<MP3File> mp3files, string PlaylistName, string plsavepath, string changeMusicPath = null)
        {
            try
            {
                ...
                StreamWriter pm3u = new(playliststream, Encoding.Latin1);
                //pm3u.WriteLine("#EXTM3U");
                //Durchlaufen und schreiben
                string[] peaches = Array.Empty<string>();
